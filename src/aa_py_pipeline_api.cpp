...
namespace astroaccelerate {
  namespace python {
	...
	aa_filterbank_metadata metadata(aa_py_metadata.m_tstart, aa_py_metadata.m_tsamp, aa_py_metadata.m_nbits, aa_py_metadata.m_nsamples, aa_py_metadata.m_fch1, aa_py_metadata.m_foff, aa_py_metadata.m_sign_bw, aa_py_metadata.m_nchans); //new edit sign_bw added
	...
	if(options.set_bandpass_average) pipeline_options.insert(aa_pipeline::component_option::set_bandpass_average);
